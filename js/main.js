...
(function (){
	...
	zns.site.user.createDOM=function ()
	{
		...
		(function (){
			...
			'<span></span>'+
			'<a href="javascript:;" class="pay_attention_to_us">关于作品</a>';
...
(function (){
	...
	//设置图片路径
	var tempNewDiv=
	'<a href="images/product_pic/{pic}" data-lightbox="images/product_pic/{pic}"  title="民院风采">'+
	'<img src="images/product_pic/{pic}" />'+
	'</a>'+
	'<div class="hidden_txt"><strong>'+
	'<a href="images/product_pic/{pic}" data-lightbox="images/product_pic/{pic}"  title="民院风采" style="color:white;">'+
	'{name}'+
	'</a>'+
...
(function (){
	...
	zns.site.fx.browser_test.createDOM=function ()
	{
		...
		'Sum90官网大量采用了HTML5技术进行开发，所以低版本浏览器将无法展现网站的全部效果，建议您升级浏览器，然后进行访问。<br><br>'+
		'<em>因为Sum90官网使用了Web3D技术，所以在没有显卡的计算机上，升级浏览器后仍会收到此提示，这时您将仍无法查看部分3D效果</em>'+
		'</p>'+
		'<p class="browser_btn">'+
